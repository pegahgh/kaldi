...
if [ $stage -le 6 ]; then
  ...
  steps/online/nnet2/train_diag_ubm.sh --cmd "$train_cmd" --nj 30 --num-frames 500000 \
    data/multi/${train_set}_hires 4096 exp/$L/nnet3/tri3b exp/multi/nnet3/diag_ubm
fi
...
if [ $stage -le 7 ]; then
  ...
  steps/online/nnet2/train_ivector_extractor.sh --cmd "$train_cmd" --nj 10 \
    data/multi/${train_set}_hires exp/multi/nnet3/diag_ubm exp/multi/nnet3/extractor || exit 1;
fi
